...
WORKSPACE_DESCRIPTION = (
    ...
    "read_file(path,offset,length); read_multiple_files(paths,offset,length) or ranges:[{path,offset,length}]; "
    "search_files also accepts query as an alias for pattern. "
